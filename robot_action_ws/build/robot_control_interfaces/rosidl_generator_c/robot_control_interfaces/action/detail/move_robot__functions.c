...
robot_control_interfaces__action__MoveRobot_Result__init(robot_control_interfaces__action__MoveRobot_Result * msg)
{
  ...
  // execution_status
  if (!rosidl_runtime_c__String__init(&msg->execution_status)) {
    robot_control_interfaces__action__MoveRobot_Result__fini(msg);
    return false;
  }
  // progress
...
robot_control_interfaces__action__MoveRobot_Result__fini(robot_control_interfaces__action__MoveRobot_Result * msg)
{
  ...
  // execution_status
  rosidl_runtime_c__String__fini(&msg->execution_status);
  // progress
  // count
  // start_time
}
...
robot_control_interfaces__action__MoveRobot_Result__are_equal(const robot_control_interfaces__action__MoveRobot_Result * lhs, const robot_control_interfaces__action__MoveRobot_Result * rhs)
{
  ...
  // execution_status
  if (!rosidl_runtime_c__String__are_equal(
      &(lhs->execution_status), &(rhs->execution_status)))
  {
    return false;
  }
  // progress
  ...
  robot_control_interfaces__action__MoveRobot_Result * output)
{
  ...
  // execution_status
  if (!rosidl_runtime_c__String__copy(
      &(input->execution_status), &(output->execution_status)))
  {
    return false;
  }
  // progress
...
bool
robot_control_interfaces__action__MoveRobot_SendGoal_Event__init(robot_control_interfaces__action__MoveRobot_SendGoal_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    robot_control_interfaces__action__MoveRobot_SendGoal_Event__fini(msg);
    return false;
  }
  // request
  if (!robot_control_interfaces__action__MoveRobot_SendGoal_Request__Sequence__init(&msg->request, 0)) {
    robot_control_interfaces__action__MoveRobot_SendGoal_Event__fini(msg);
    return false;
  }
  // response
  if (!robot_control_interfaces__action__MoveRobot_SendGoal_Response__Sequence__init(&msg->response, 0)) {
    robot_control_interfaces__action__MoveRobot_SendGoal_Event__fini(msg);
    return false;
  }
  return true;
...
void
robot_control_interfaces__action__MoveRobot_SendGoal_Event__fini(robot_control_interfaces__action__MoveRobot_SendGoal_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  robot_control_interfaces__action__MoveRobot_SendGoal_Request__Sequence__fini(&msg->request);
  // response
  robot_control_interfaces__action__MoveRobot_SendGoal_Response__Sequence__fini(&msg->response);
}

bool
robot_control_interfaces__action__MoveRobot_SendGoal_Event__are_equal(const robot_control_interfaces__action__MoveRobot_SendGoal_Event * lhs, const robot_control_interfaces__action__MoveRobot_SendGoal_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!robot_control_interfaces__action__MoveRobot_SendGoal_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!robot_control_interfaces__action__MoveRobot_SendGoal_Response__Sequence__are_equal(
...
bool
robot_control_interfaces__action__MoveRobot_SendGoal_Event__copy(
  const robot_control_interfaces__action__MoveRobot_SendGoal_Event * input,
  robot_control_interfaces__action__MoveRobot_SendGoal_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!robot_control_interfaces__action__MoveRobot_SendGoal_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!robot_control_interfaces__action__MoveRobot_SendGoal_Response__Sequence__copy(
...
robot_control_interfaces__action__MoveRobot_SendGoal_Event__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_control_interfaces__action__MoveRobot_SendGoal_Event * msg = (robot_control_interfaces__action__MoveRobot_SendGoal_Event *)allocator.allocate(sizeof(robot_control_interfaces__action__MoveRobot_SendGoal_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robot_control_interfaces__action__MoveRobot_SendGoal_Event));
  bool success = robot_control_interfaces__action__MoveRobot_SendGoal_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
robot_control_interfaces__action__MoveRobot_SendGoal_Event__destroy(robot_control_interfaces__action__MoveRobot_SendGoal_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    robot_control_interfaces__action__MoveRobot_SendGoal_Event__fini(msg);
...
bool
robot_control_interfaces__action__MoveRobot_SendGoal_Event__Sequence__init(robot_control_interfaces__action__MoveRobot_SendGoal_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_control_interfaces__action__MoveRobot_SendGoal_Event * data = NULL;

  if (size) {
    data = (robot_control_interfaces__action__MoveRobot_SendGoal_Event *)allocator.zero_allocate(size, sizeof(robot_control_interfaces__action__MoveRobot_SendGoal_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robot_control_interfaces__action__MoveRobot_SendGoal_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robot_control_interfaces__action__MoveRobot_SendGoal_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
robot_control_interfaces__action__MoveRobot_SendGoal_Event__Sequence__fini(robot_control_interfaces__action__MoveRobot_SendGoal_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robot_control_interfaces__action__MoveRobot_SendGoal_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
robot_control_interfaces__action__MoveRobot_SendGoal_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_control_interfaces__action__MoveRobot_SendGoal_Event__Sequence * array = (robot_control_interfaces__action__MoveRobot_SendGoal_Event__Sequence *)allocator.allocate(sizeof(robot_control_interfaces__action__MoveRobot_SendGoal_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robot_control_interfaces__action__MoveRobot_SendGoal_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
robot_control_interfaces__action__MoveRobot_SendGoal_Event__Sequence__destroy(robot_control_interfaces__action__MoveRobot_SendGoal_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robot_control_interfaces__action__MoveRobot_SendGoal_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
robot_control_interfaces__action__MoveRobot_SendGoal_Event__Sequence__are_equal(const robot_control_interfaces__action__MoveRobot_SendGoal_Event__Sequence * lhs, const robot_control_interfaces__action__MoveRobot_SendGoal_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robot_control_interfaces__action__MoveRobot_SendGoal_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
robot_control_interfaces__action__MoveRobot_SendGoal_Event__Sequence__copy(
  const robot_control_interfaces__action__MoveRobot_SendGoal_Event__Sequence * input,
  robot_control_interfaces__action__MoveRobot_SendGoal_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robot_control_interfaces__action__MoveRobot_SendGoal_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robot_control_interfaces__action__MoveRobot_SendGoal_Event * data =
      (robot_control_interfaces__action__MoveRobot_SendGoal_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robot_control_interfaces__action__MoveRobot_SendGoal_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robot_control_interfaces__action__MoveRobot_SendGoal_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robot_control_interfaces__action__MoveRobot_SendGoal_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
bool
robot_control_interfaces__action__MoveRobot_GetResult_Event__init(robot_control_interfaces__action__MoveRobot_GetResult_Event * msg)
{
  if (!msg) {
    return false;
  }
  // info
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    robot_control_interfaces__action__MoveRobot_GetResult_Event__fini(msg);
    return false;
  }
  // request
  if (!robot_control_interfaces__action__MoveRobot_GetResult_Request__Sequence__init(&msg->request, 0)) {
    robot_control_interfaces__action__MoveRobot_GetResult_Event__fini(msg);
    return false;
  }
  // response
  if (!robot_control_interfaces__action__MoveRobot_GetResult_Response__Sequence__init(&msg->response, 0)) {
    robot_control_interfaces__action__MoveRobot_GetResult_Event__fini(msg);
    return false;
  }
  return true;
...
void
robot_control_interfaces__action__MoveRobot_GetResult_Event__fini(robot_control_interfaces__action__MoveRobot_GetResult_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  service_msgs__msg__ServiceEventInfo__fini(&msg->info);
  // request
  robot_control_interfaces__action__MoveRobot_GetResult_Request__Sequence__fini(&msg->request);
  // response
  robot_control_interfaces__action__MoveRobot_GetResult_Response__Sequence__fini(&msg->response);
}

bool
robot_control_interfaces__action__MoveRobot_GetResult_Event__are_equal(const robot_control_interfaces__action__MoveRobot_GetResult_Event * lhs, const robot_control_interfaces__action__MoveRobot_GetResult_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!robot_control_interfaces__action__MoveRobot_GetResult_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!robot_control_interfaces__action__MoveRobot_GetResult_Response__Sequence__are_equal(
      &(lhs->response), &(rhs->response)))
  {
    return false;
  }
...
bool
robot_control_interfaces__action__MoveRobot_GetResult_Event__copy(
  const robot_control_interfaces__action__MoveRobot_GetResult_Event * input,
  robot_control_interfaces__action__MoveRobot_GetResult_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!robot_control_interfaces__action__MoveRobot_GetResult_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!robot_control_interfaces__action__MoveRobot_GetResult_Response__Sequence__copy(
      &(input->response), &(output->response)))
  {
    return false;
  }
...
robot_control_interfaces__action__MoveRobot_GetResult_Event__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_control_interfaces__action__MoveRobot_GetResult_Event * msg = (robot_control_interfaces__action__MoveRobot_GetResult_Event *)allocator.allocate(sizeof(robot_control_interfaces__action__MoveRobot_GetResult_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robot_control_interfaces__action__MoveRobot_GetResult_Event));
  bool success = robot_control_interfaces__action__MoveRobot_GetResult_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
robot_control_interfaces__action__MoveRobot_GetResult_Event__destroy(robot_control_interfaces__action__MoveRobot_GetResult_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    robot_control_interfaces__action__MoveRobot_GetResult_Event__fini(msg);
...
bool
robot_control_interfaces__action__MoveRobot_GetResult_Event__Sequence__init(robot_control_interfaces__action__MoveRobot_GetResult_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_control_interfaces__action__MoveRobot_GetResult_Event * data = NULL;

  if (size) {
    data = (robot_control_interfaces__action__MoveRobot_GetResult_Event *)allocator.zero_allocate(size, sizeof(robot_control_interfaces__action__MoveRobot_GetResult_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robot_control_interfaces__action__MoveRobot_GetResult_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robot_control_interfaces__action__MoveRobot_GetResult_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
robot_control_interfaces__action__MoveRobot_GetResult_Event__Sequence__fini(robot_control_interfaces__action__MoveRobot_GetResult_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robot_control_interfaces__action__MoveRobot_GetResult_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
robot_control_interfaces__action__MoveRobot_GetResult_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_control_interfaces__action__MoveRobot_GetResult_Event__Sequence * array = (robot_control_interfaces__action__MoveRobot_GetResult_Event__Sequence *)allocator.allocate(sizeof(robot_control_interfaces__action__MoveRobot_GetResult_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robot_control_interfaces__action__MoveRobot_GetResult_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
robot_control_interfaces__action__MoveRobot_GetResult_Event__Sequence__destroy(robot_control_interfaces__action__MoveRobot_GetResult_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robot_control_interfaces__action__MoveRobot_GetResult_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
robot_control_interfaces__action__MoveRobot_GetResult_Event__Sequence__are_equal(const robot_control_interfaces__action__MoveRobot_GetResult_Event__Sequence * lhs, const robot_control_interfaces__action__MoveRobot_GetResult_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robot_control_interfaces__action__MoveRobot_GetResult_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
robot_control_interfaces__action__MoveRobot_GetResult_Event__Sequence__copy(
  const robot_control_interfaces__action__MoveRobot_GetResult_Event__Sequence * input,
  robot_control_interfaces__action__MoveRobot_GetResult_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robot_control_interfaces__action__MoveRobot_GetResult_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robot_control_interfaces__action__MoveRobot_GetResult_Event * data =
      (robot_control_interfaces__action__MoveRobot_GetResult_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robot_control_interfaces__action__MoveRobot_GetResult_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robot_control_interfaces__action__MoveRobot_GetResult_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robot_control_interfaces__action__MoveRobot_GetResult_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
