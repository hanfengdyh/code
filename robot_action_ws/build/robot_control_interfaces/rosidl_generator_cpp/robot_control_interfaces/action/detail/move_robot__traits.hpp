  ...
  std::ostream & out)
{
  ...
  // member: execution_status
  {
    ...
    rosidl_generator_traits::value_to_yaml(msg.execution_status, out);
    out << ", ";
  }
...
inline void to_flow_style_yaml(
  const MoveRobot_SendGoal_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const MoveRobot_SendGoal_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use robot_control_interfaces::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const robot_control_interfaces::action::MoveRobot_SendGoal_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  robot_control_interfaces::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use robot_control_interfaces::action::to_yaml() instead")]]
inline std::string to_yaml(const robot_control_interfaces::action::MoveRobot_SendGoal_Event & msg)
{
  return robot_control_interfaces::action::to_yaml(msg);
}

template<>
inline const char * data_type<robot_control_interfaces::action::MoveRobot_SendGoal_Event>()
{
  return "robot_control_interfaces::action::MoveRobot_SendGoal_Event";
}

template<>
inline const char * name<robot_control_interfaces::action::MoveRobot_SendGoal_Event>()
{
  return "robot_control_interfaces/action/MoveRobot_SendGoal_Event";
}

template<>
struct has_fixed_size<robot_control_interfaces::action::MoveRobot_SendGoal_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<robot_control_interfaces::action::MoveRobot_SendGoal_Event>
  : std::integral_constant<bool, has_bounded_size<robot_control_interfaces::action::MoveRobot_SendGoal_Request>::value && has_bounded_size<robot_control_interfaces::action::MoveRobot_SendGoal_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<robot_control_interfaces::action::MoveRobot_SendGoal_Event>
  : std::true_type {};
...
inline void to_flow_style_yaml(
  const MoveRobot_GetResult_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const MoveRobot_GetResult_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use robot_control_interfaces::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const robot_control_interfaces::action::MoveRobot_GetResult_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  robot_control_interfaces::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use robot_control_interfaces::action::to_yaml() instead")]]
inline std::string to_yaml(const robot_control_interfaces::action::MoveRobot_GetResult_Event & msg)
{
  return robot_control_interfaces::action::to_yaml(msg);
}

template<>
inline const char * data_type<robot_control_interfaces::action::MoveRobot_GetResult_Event>()
{
  return "robot_control_interfaces::action::MoveRobot_GetResult_Event";
}

template<>
inline const char * name<robot_control_interfaces::action::MoveRobot_GetResult_Event>()
{
  return "robot_control_interfaces/action/MoveRobot_GetResult_Event";
}

template<>
struct has_fixed_size<robot_control_interfaces::action::MoveRobot_GetResult_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<robot_control_interfaces::action::MoveRobot_GetResult_Event>
  : std::integral_constant<bool, has_bounded_size<robot_control_interfaces::action::MoveRobot_GetResult_Request>::value && has_bounded_size<robot_control_interfaces::action::MoveRobot_GetResult_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<robot_control_interfaces::action::MoveRobot_GetResult_Event>
  : std::true_type {};
